...
/**
 * Critter is interface of living things.
 * Critters are considered no model Observer and Model Critters.
 * Model Critter is Player and NPCs.
 * Only player has camera.
 * 
...
public interface Critter { // interface for Observer, Player and NPC
    ...
    /**
     * Move this critter in front direction for amount.
     * Also to move critter has to have give control (set to true).
     * 
    ...
    /**
     * Move this critter in back direction for amount.
     * Also to move critter has to have give control (set to true).
     * 
     * @param amount amount to move this critter
     */
    ...
    /**
     * Move this critter in left direction for amount.
     * Also to move critter has to have give control (set to true).
     * 
     * @param amount amount to move this critter
     */
    ...
    /**
     * Move this critter in right direction for amount.
     * Also to move critter has to have give control (set to true).
     * 
     * @param amount amount to move this critter
     */
    ...
    //--------------------------------------------------------------------------
    /**
     * Move this critter prediction forward (but critter stays).
    ...
    /**
     * Move this critter prediction backward (but critter stays).
     * Used for collision testing.
     * 
     * @param amount amount to move this critter predictor
     */
    ...
    /**
     * Move this critter prediction left (but critter stays).
     * Used for collision testing.
     * 
     * @param amount amount to move this critter predictor
     */
    ...
    /**
     * Move this critter prediction right (but critter stays).
     * Used for collision testing.
     * 
     * @param amount amount to move this critter predictor
     */
    ...
    //--------------------------------------------------------------------------
    /**
     * Turn this critter left side for given angle.
     * To turn critter has to have give control (set to true).
     * 
    ...
    /**
     * Turn this critter right side for given angle.
     * To turn critter has to have give control (set to true).
     * 
    ...
    /**
     * Look for xoffset, yoffset using Euler angles.
     * Requires given control (set to true)
     * 
    ...
    /**
     * Look at exactly yaw & pitch angle using Euler angles.Requires given control (set to true)
     * 
    ...
    /**
     * Render this critter.
     * To render needs to be buffered.
     * 
     ...
     * 
     * @param givenControl desired given control flag (true - allows, false - disallows)
     */
