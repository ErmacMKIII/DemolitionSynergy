...
public class RandomLevelGenerator {
    ...
    private Block generateRandomSolidBlock() {
        ...
        } while (LevelContainer.ALL_SOLID_POS.containsKey(randPos)
                || LevelContainer.ALL_FLUID_POS.containsKey(randPos)
    ...
    private Block generateRandomSolidBlockAdjacent(Block block) {
        ...
        } while (LevelContainer.ALL_SOLID_POS.containsKey(adjPos)
                || LevelContainer.ALL_FLUID_POS.containsKey(adjPos)
